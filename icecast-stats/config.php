<?php
//error_reporting(0);
define(SERVER, 'http://radio.canstream.co.uk:8507');//your icecast server address, without the ending "/"
define(MOUNT, 'status.xsl?mount=/live.mp3'); //your radio's mount point, with the leading "/"
...
define(GET_ALBUM_INFO, false); //get extra information of the album from last.fm, if enabled, may increase script execute time
